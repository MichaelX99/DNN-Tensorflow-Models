...
def inference(images):
    ...
    transition1 = helper.transition(input1, k, 'transition1')

    input2 = helper.dense_block(transition1, k, b2, 'conv2')
    transition2 = helper.transition(input2, k, 'transition2')

    input3 = helper.dense_block(transition2, k, b1, 'conv3')
    transition3 = helper.transition(input3, k, 'transition3')

    input4 = helper.dense_block(transition3, k, b1, 'conv4')
